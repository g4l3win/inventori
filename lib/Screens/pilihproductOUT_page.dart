...
class PilihProductOUTPage extends StatelessWidget {
  @override
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                if (enteredQuantity != null) {
                  print('Mengurangi $enteredQuantity unit $productName dari inventaris.');
                  _showSnackBar(context, 'Mengurangi $enteredQuantity unit $productName dari inventaris.');
                }
                Navigator.of(context).pop();
              },
            ),
